  ...
  internal = rec {
    ...
    crates = {
      ...
      "gen-macros" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../gen/crates/gen-macros; };
        procMacro = true;
        libName = "gen_macros";
        authors = [
          "pleme-io"
      ...
      "gen-platform" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../gen/crates/gen-platform; };
      ...
      "gen-types" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../gen/crates/gen-types; };
        libName = "gen_types";
        authors = [
          "pleme-io"
        ];
