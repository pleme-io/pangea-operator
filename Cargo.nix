  ...
  internal = rec {
    ...
    crates = {
      ...
      "assert_cmd" = rec {
        ...
        edition = "2021";
        crateBin = [];
        sha256 = "11dz6ljl8v9alh6mcbhdp0niibgxraxhibs24i1y1a8aacj6kfxw";
        authors = [
      ...
      "async-graphql" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "dataloader" "default" "email-validator" "fast_chemail" "futures-channel" "graphiql" "handlebars" "lru" "playground" "tempfile" "uuid" ];
      };
      "async-graphql-axum" = rec {
        crateName = "async-graphql-axum";
        version = "7.0.17";
        edition = "2024";
        sha256 = "1cbbvdmkrxfyvmry25zilavv5mvi82f63f2h243rwfdzrx78f9c7";
      ...
      "pangea-cli" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./pangea-cli; };
        authors = [
      ...
      "pangea-operator" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./pangea-operator; };
        libName = "pangea_operator";
        authors = [
          "Pleme <engineering@pleme.io>"
        ];
        dependencies = [
          ...
          }
          {
            ...
            packageId = "async-graphql";
            optional = true;
            features = [ "dataloader" "chrono" "uuid" ];
          }
          {
          ...
          }
          {
            name = "sqlx";
            packageId = "sqlx";
            features = [ "postgres" "runtime-tokio" "tls-rustls" "chrono" "uuid" ];
          }
          {
            name = "strum";
            packageId = "strum";
      ...
      "pangea-types" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./pangea-types; };
        libName = "pangea_types";
        authors = [
          "Pleme <engineering@pleme.io>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "async-graphql" "client" "cynic" "default" "server" ];
      };
      "pangea-web" = rec {
        crateName = "pangea-web";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./pangea-web; };
      ...
      "papergrid" = rec {
        ...
        version = "0.13.0";
        edition = "2018";
        sha256 = "1ggfj9xvqqazcc2avmi9va40crdmlxjxlgjzi4yf25ziy7ggic6j";
        authors = [
      ...
      "tabled" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "02ji1rhr6kig7mhh3zlwbflqghadav6mj1g5gi13fccpyci94w66";
        authors = [
          "Maxim Zhiburt <zhiburt@gmail.com>"
        ];
        dependencies = [
      ...
      "tabled_derive" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "1qggphxj9qnc41m105cqncv9pv5zrhwrffhz183m8k3xc9vf86wk";
        procMacro = true;
        authors = [
          "Maxim Zhiburt <zhiburt@gmail.com>"
        ];
      ...
      "tokio-stream" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "fs" "net" "sync" "time" "tokio-util" ];
      };
      "tokio-test" = rec {
      ...
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "auth" "base64" "cors" "default" "follow-redirect" "futures-util" "iri-string" "map-response-body" "mime" "tower" "trace" "tracing" "validate-request" ];
      };
      "tower-layer" = rec {
      ...
      "tracing-opentelemetry" = rec {
        ...
        version = "0.27.0";
        edition = "2021";
        sha256 = "02rnqyrk614cs8rmlziniqrzg4q0xjd2icxb5i312n3c7xfsyn6w";
